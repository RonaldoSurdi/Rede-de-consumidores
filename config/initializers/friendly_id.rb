# FriendlyId Global Parametrizacao
#
# Use this to set up shared parametrizacao options for your entire application.
# Any of the parametrizacao options shown here can also be applied to single
